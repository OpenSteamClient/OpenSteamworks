...
public:
    ...
    virtual unknown ShutdownSystem() = 0; //argc: 0, index 3
    virtual unknown SuspendSystem() = 0; //argc: 0, index 4
    virtual unknown RestartSystem() = 0; //argc: 0, index 5
    virtual unknown FactoryReset() = 0; //argc: 0, index 6
    ...
    virtual unknown GetOSBranchList() = 0; //argc: 0, index 11
    virtual unknown GetCurrentOSBranch() = 0; //argc: 0, index 12
    virtual unknown SelectOSBranch() = 0; //argc: 1, index 13
    virtual unknown GetUpdateState() = 0; //argc: 1, index 14
    virtual unknown CheckForUpdate() = 0; //argc: 0, index 15
    ...
    virtual unknown RunDeckMicEnableHack() = 0; //argc: 0, index 19
    virtual unknown RunDeckEchoCancellationHack() = 0; //argc: 0, index 20
};