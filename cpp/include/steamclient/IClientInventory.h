...
public:
    ...
    virtual bool GenerateItems(SteamInventoryResult_t *pResultHandle, const SteamItemDef_t *pArrayItemDefs, uint32 unArrayItemDefs, const uint32 *punArrayQuantity, uint32 unArrayLength) = 0; //argc: 5, index 11
    ...
    virtual bool TriggerItemDrop(SteamInventoryResult_t *pResultHandle, SteamItemDef_t dropListDefinition) = 0; //argc: 2, index 17
    virtual bool TradeItems(SteamInventoryResult_t *pResultHandle, CSteamID steamIDTradePartner, const SteamItemInstanceID_t *pArrayGive, uint32 unArrayGiveLen, const uint32 *pArrayGiveQuantity, uint32 nArrayGiveQuantityLength, const SteamItemInstanceID_t *pArrayGet, uint32 unArrayGetLen, const uint32 *pArrayGetQuantity, uint32 nArrayGetQuantityLength) = 0; //argc: 11, index 18
    virtual bool LoadItemDefinitions() = 0; //argc: 0, index 19
    virtual bool GetItemDefinitionIDs(SteamItemDef_t *pItemDefIDs, uint32 unItemDefIDsLen, uint32 *punItemDefIDsArraySize) = 0; //argc: 3, index 20
    ...
    virtual bool GetItemPrice(SteamItemDef_t iDefinition, uint64 *pCurrentPrice, uint64 *pBasePrice) = 0; //argc: 3, index 28
    virtual SteamInventoryUpdateHandle_t StartUpdateProperties() = 0; //argc: 0, index 29
    virtual bool RemoveProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName) = 0; //argc: 5, index 30
    virtual bool SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, const char *pchPropertyValue) = 0; //argc: 6, index 31
    virtual bool SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, bool bValue) = 0; //argc: 6, index 32
    ...
    virtual bool SetProperty(SteamInventoryUpdateHandle_t handle, SteamItemInstanceID_t nItemID, const char *pchPropertyName, float flValue) = 0; //argc: 6, index 34
    virtual bool SubmitUpdateProperties(SteamInventoryUpdateHandle_t handle, SteamInventoryResult_t * pResultHandle) = 0; //argc: 3, index 35
    virtual bool InspectItem(SteamInventoryResult_t *pResultHandle, const char *pchItemToken) = 0; //argc: 2, index 36
    virtual void TEST_ClearMsgCache() = 0; //argc: 0, index 37
};