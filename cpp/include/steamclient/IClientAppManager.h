...
public:
    ...
    virtual unknown_ret GetAppInstallState() = 0; //argc: 1, index 5
    virtual int GetAppInstallDir(AppId_t appid, char* buf, int bufSize) = 0; //argc: 3, index 6
    virtual unknown_ret GetAppContentInfo() = 0; //argc: 6, index 7
    virtual unknown_ret GetAppStagingInfo() = 0; //argc: 3, index 8
    virtual unknown_ret BGetContentInfoForApps() = 0; //argc: 2, index 9
    virtual unknown_ret IsAppDlcInstalled() = 0; //argc: 2, index 10
    virtual unknown_ret GetDlcDownloadProgress() = 0; //argc: 4, index 11
    virtual unknown_ret BIsDlcEnabled() = 0; //argc: 3, index 12
    virtual unknown_ret SetDlcEnabled() = 0; //argc: 3, index 13
    virtual unknown_ret SetDlcContext() = 0; //argc: 2, index 14
    ...
    virtual unknown_ret MarkContentCorrupt() = 0; //argc: 2, index 30
    virtual unknown_ret GetInstalledDepots() = 0; //argc: 3, index 31
    virtual unknown_ret GetFileDetails() = 0; //argc: 2, index 32
    virtual unknown_ret VerifySignedFiles() = 0; //argc: 1, index 33
    ...
    virtual unknown_ret GetAppStateInfo() = 0; //argc: 2, index 70
    ...
    virtual unknown_ret GetLaunchQueryParam() = 0; //argc: 2, index 91
    ...
    virtual unknown_ret GetLaunchCommandLine() = 0; //argc: 3, index 95
