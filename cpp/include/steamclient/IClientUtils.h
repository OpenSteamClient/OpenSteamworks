...
public:
    ...
    virtual unknown GetSteamRealm() = 0; //argc: 0, index 9
    ...
    virtual unknown GetBatteryInformation() = 0; //argc: 2, index 16
    virtual unknown SetOfflineMode() = 0; //argc: 1, index 17
    virtual unknown GetOfflineMode() = 0; //argc: 0, index 18
    ...
    virtual unknown SetAPICallResultWithoutPostingCallback() = 0; //argc: 5, index 26
    virtual unknown SignalAppsToShutDown() = 0; //argc: 0, index 27
    virtual unknown SignalServiceAppsToDisconnect() = 0; //argc: 0, index 28
    virtual unknown TerminateAllApps() = 0; //argc: 1, index 29
    virtual unknown GetCellID() = 0; //argc: 0, index 30
    ...
    virtual unknown GetBuildID() = 0; //argc: 0, index 34
    ...
    virtual unknown ShutdownLauncher() = 0; //argc: 2, index 39
    virtual unknown SetLauncherType() = 0; //argc: 1, index 40
    virtual unknown GetLauncherType() = 0; //argc: 0, index 41
    ...
    virtual unknown GamepadTextInputClosed() = 0; //argc: 3, index 45
    virtual unknown ShowControllerLayoutPreview() = 0; //argc: 3, index 46
    virtual unknown SetSpew() = 0; //argc: 3, index 47
    virtual bool BDownloadsDisabled() = 0; //argc: 0, index 48
    virtual unknown SetFocusedWindow() = 0; //argc: 4, index 49
    virtual const char *GetSteamUILanguage() = 0; //argc: 0, index 50
    virtual unknown CheckSteamReachable() = 0; //argc: 0, index 51
    virtual unknown SetLastGameLaunchMethod() = 0; //argc: 1, index 52
    virtual unknown SetVideoAdapterInfo() = 0; //argc: 7, index 53
    virtual unknown SetOverlayWindowFocusForPipe() = 0; //argc: 3, index 54
    virtual unknown GetGameOverlayUIInstanceFocusGameID() = 0; //argc: 3, index 55
    virtual unknown GetFocusedGameWindow() = 0; //argc: 3, index 56
    virtual unknown SetControllerConfigFileForAppID() = 0; //argc: 2, index 57
    virtual unknown GetControllerConfigFileForAppID() = 0; //argc: 3, index 58
    ...
    virtual unknown GenerateSupportSystemReport() = 0; //argc: 0, index 63
    virtual unknown GetSupportSystemReport() = 0; //argc: 4, index 64
    virtual unknown GetAppIdForPid() = 0; //argc: 2, index 65
    virtual unknown SetClientUIProcess() = 0; //argc: 0, index 66
    virtual bool BIsClientUIInForeground() = 0; //argc: 0, index 67
    virtual unknown AllowSetForegroundThroughWebhelper() = 0; //argc: 1, index 68
    virtual unknown SetOverlayBrowserInfo() = 0; //argc: 8, index 69
    virtual unknown ClearOverlayBrowserInfo() = 0; //argc: 1, index 70
    virtual unknown GetOverlayBrowserInfo() = 0; //argc: 3, index 71
    virtual unknown SetOverlayNotificationPosition() = 0; //argc: 2, index 72
    virtual unknown SetOverlayNotificationInset() = 0; //argc: 3, index 73
    virtual unknown DispatchClientUINotification() = 0; //argc: 3, index 74
    virtual unknown RespondToClientUINotification() = 0; //argc: 3, index 75
    virtual unknown DispatchClientUICommand() = 0; //argc: 2, index 76
    virtual unknown DispatchComputerActiveStateChange() = 0; //argc: 0, index 77
    virtual unknown DispatchOpenURLInClient() = 0; //argc: 3, index 78
    virtual unknown DispatchClearAllBrowsingData() = 0; //argc: 0, index 79
    virtual unknown DispatchClientSettingsChanged() = 0; //argc: 0, index 80
    virtual unknown DispatchClientPostMessage() = 0; //argc: 3, index 81
    ...
    virtual unknown ScheduleConnectivityTest() = 0; //argc: 2, index 87
    virtual unknown GetConnectivityTestState() = 0; //argc: 1, index 88
    virtual unknown GetCaptivePortalURL() = 0; //argc: 0, index 89
    virtual void RecordSteamInterfaceCreation(const char *interfaceVersion, const char *simpleName) = 0; //argc: 2, index 90
    virtual unknown GetCloudGamingPlatform() = 0; //argc: 0, index 91
    virtual unknown BGetMacAddresses() = 0; //argc: 3, index 92
    virtual unknown BGetDiskSerialNumber() = 0; //argc: 2, index 93
    virtual int GetSteamEnvironmentForApp(AppId_t appid, char *buf, int bufMax) = 0; //argc: 3, index 94
    virtual unknown TestHTTP() = 0; //argc: 1, index 95
    virtual unknown DumpJobs() = 0; //argc: 1, index 96
    ...
    virtual unknown DismissGamepadTextInput() = 0; //argc: 1, index 99
    virtual unknown FloatingGamepadTextInputDismissed() = 0; //argc: 0, index 100
    virtual void SetGameLauncherMode(AppId_t appid, bool bLauncherMode) = 0; //argc: 2, index 101
    virtual unknown ClearAllHTTPCaches() = 0; //argc: 0, index 102
    virtual unknown GetFocusedGameID() = 0; //argc: 1, index 103
    virtual unknown GetFocusedWindowPID() = 0; //argc: 0, index 104
    virtual unknown SetWebUITransportWebhelperPID() = 0; //argc: 1, index 105
    virtual unknown GetWebUITransportInfo() = 0; //argc: 1, index 106
    virtual unknown RecordFakeReactRouteMetric() = 0; //argc: 1, index 107
    virtual unknown SteamRuntimeSystemInfo() = 0; //argc: 1, index 108
    virtual unknown DumpHTTPClients() = 0; //argc: 1, index 109
    virtual unknown BGetMachineID() = 0; //argc: 1, index 110
    virtual void NotifyMissingInterface(const char *name) = 0; //argc: 1, index 111
    virtual unknown IsSteamInTournamentMode() = 0; //argc: 0, index 112
    virtual unknown DesktopLockedStateChanged() = 0; //argc: 1, index 113
};