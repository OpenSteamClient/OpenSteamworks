...
{
public:
    virtual bool BIsParentalLockEnabled() = 0; //argc: -1, index 1
    virtual bool BIsParentalLockLocked() = 0; //argc: -1, index 2
    ...
    virtual bool BGetRecoveryEmail(char *emailBuf, int emailBufSize) = 0; //argc: -1, index 8
    virtual bool BIsLockFromSiteLicense() = 0; //argc: -1, index 9
};