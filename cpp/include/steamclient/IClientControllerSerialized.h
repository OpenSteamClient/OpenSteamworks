...
public:
    ...
    virtual unknown_ret SendOSKeyboardEvent() = 0; //argc: 1, index 116
    virtual unknown_ret SetOSKeyboardKey() = 0; //argc: 2, index 117
    virtual unknown_ret SetMousePosition() = 0; //argc: 3, index 118
    virtual unknown_ret GetGamepadIndexChangeCounter() = 0; //argc: 0, index 119
    virtual unknown_ret BSwapGamepadIndex() = 0; //argc: 3, index 120
    virtual unknown_ret GetGamepadIndexForXInputIndex() = 0; //argc: 1, index 121
    virtual unknown_ret GetControllerIndexForGamepadIndex() = 0; //argc: 1, index 122
    virtual unknown_ret AutoRegisterControllerRegistrationToAccount() = 0; //argc: 2, index 123
    virtual unknown_ret GetConfigForAppAndController() = 0; //argc: 4, index 124
    virtual unknown_ret SetControllerPersonalization() = 0; //argc: 3, index 125
    virtual unknown_ret SetPersonalizationFile() = 0; //argc: 4, index 126
    virtual unknown_ret SetGameWindowPos() = 0; //argc: 4, index 127
    virtual unknown_ret HasGameMapping() = 0; //argc: 1, index 128
    virtual unknown_ret GetControllerUsageData() = 0; //argc: 2, index 129
    virtual unknown_ret BAllowAppConfigForController() = 0; //argc: 2, index 130
    virtual unknown_ret ResetControllerEnableCache() = 0; //argc: 0, index 131
    virtual unknown_ret GetControllerEnableSupport() = 0; //argc: 1, index 132
    virtual unknown_ret GetControllerActivityByType() = 0; //argc: 1, index 133
    virtual unknown_ret GetLastActiveControllerVID() = 0; //argc: 0, index 134
    virtual unknown_ret GetLastActiveControllerPID() = 0; //argc: 0, index 135
    virtual unknown_ret LoadControllerPersonalizationFile() = 0; //argc: 4, index 136
    virtual unknown_ret SaveControllerPersonalizationFile() = 0; //argc: 3, index 137
    virtual unknown_ret LoadRemotePlayControllerPersonalizationVDF() = 0; //argc: 2, index 138
    virtual unknown_ret FindControllerByPath() = 0; //argc: 1, index 139
    virtual unknown_ret GetControllerPath() = 0; //argc: 2, index 140
    virtual unknown_ret GetControllerProductName() = 0; //argc: 2, index 141
    virtual unknown_ret SetControllerHapticsSetting() = 0; //argc: 2, index 142
    virtual unknown_ret SetControllerName() = 0; //argc: 2, index 143
    virtual unknown_ret SetControllerRumbleSetting() = 0; //argc: 2, index 144
    virtual unknown_ret SetControllerNintendoLayoutSetting() = 0; //argc: 2, index 145
    virtual unknown_ret SetControllerUseUniversalFaceButtonGlyphs() = 0; //argc: 2, index 146
    virtual unknown_ret BGetTouchConfigData() = 0; //argc: 6, index 147
    virtual unknown_ret BSaveTouchConfigLayout() = 0; //argc: 3, index 148
    virtual unknown_ret SetGyroOn() = 0; //argc: 3, index 149
    virtual unknown_ret ForceSimpleHapticEvent() = 0; //argc: 5, index 150
    virtual unknown_ret GetControllerMacAddr() = 0; //argc: 3, index 151
};