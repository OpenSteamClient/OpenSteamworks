...
public:
    ...
    virtual const char *GetStatName(CGameID nGameID, uint32 iStat) = 0; //argc: 2, index 2
    virtual ESteamUserStatType GetStatType(CGameID nGameID, const char *pchName) = 0; //argc: 2, index 3
    virtual uint32 GetNumAchievements(CGameID gameID) = 0; //argc: 1, index 4
    virtual const char *GetAchievementName(CGameID gameID, uint32 iAchievement) = 0; //argc: 2, index 5
    ...
    virtual bool GetStat(CGameID gameid, const char *pchName, int32 *pnData) = 0; //argc: 3, index 8
    virtual bool GetStat(CGameID gameid, const char *pchName, float *pfData) = 0; //argc: 3, index 9
    virtual bool SetStat(CGameID gameid, const char *pchName, int32 nData) = 0; //argc: 3, index 10
    virtual bool SetStat(CGameID gameid, const char *pchName, float fData) = 0; //argc: 3, index 11
    virtual bool UpdateAvgRateStat(CGameID nGameID, const char *pchName, float flCountThisSession, double dSessionLength) = 0; //argc: 4, index 12
    virtual bool GetAchievement(CGameID nGameID, const char *pchName, bool *pbAchieved) = 0; //argc: 4, index 13
    virtual bool SetAchievement(CGameID nGameID, const char *pchName) = 0; //argc: 2, index 14
    virtual bool ClearAchievement(CGameID nGameID, const char *pchName) = 0; //argc: 2, index 15
    ...
    virtual const char *GetLeaderboardName(SteamLeaderboard_t hSteamLeaderboard) = 0; //argc: 2, index 31
    virtual int GetLeaderboardEntryCount(SteamLeaderboard_t hSteamLeaderboard) = 0; //argc: 2, index 32
    virtual ELeaderboardSortMethod GetLeaderboardSortMethod(SteamLeaderboard_t hSteamLeaderboard) = 0; //argc: 2, index 33
    virtual ELeaderboardDisplayType GetLeaderboardDisplayType(SteamLeaderboard_t hSteamLeaderboard) = 0; //argc: 2, index 34
    virtual SteamAPICall_t DownloadLeaderboardEntries(SteamLeaderboard_t hSteamLeaderboard, ELeaderboardDataRequest eLeaderboardDataRequest, int nRangeStart, int nRangeEnd) = 0; //argc: 5, index 35
    virtual SteamAPICall_t DownloadLeaderboardEntriesForUsers(SteamLeaderboard_t hSteamLeaderboard, CSteamID *prgUsers, int cUsers) = 0; //argc: 4, index 36
    virtual bool GetDownloadedLeaderboardEntry(SteamLeaderboardEntries_t hSteamLeaderboardEntries, int index, LeaderboardEntry_t *pLeaderboardEntry, int32 *pDetails, int cDetailsMax) = 0; //argc: 6, index 37
    ...
    virtual bool GetAchievementAchievedPercent(CGameID nGameID, const char *pchName, float *pflPercent) = 0; //argc: 3, index 47
    virtual SteamAPICall_t RequestGlobalStats(CGameID nGameID, int nHistoryDays) = 0; //argc: 2, index 48
    virtual bool GetGlobalStat(CGameID nGameID, const char *pchStatName, int64 *pData) = 0; //argc: 3, index 49
