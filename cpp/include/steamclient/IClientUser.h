...
public:
    ...
    virtual unknown_ret SetComputerInUse() = 0; //argc: 1, index 67
    ...
    virtual unknown_ret RunInstallScript() = 0; //argc: 2, index 100
    ...
    virtual unknown_ret BSupportUser() = 0; //argc: 0, index 140
    virtual unknown_ret BNeedsSSANextSteamLogon() = 0; //argc: 0, index 141
    virtual unknown_ret ClearNeedsSSANextSteamLogon() = 0; //argc: 0, index 142
    virtual unknown_ret BIsAppOverlayEnabled() = 0; //argc: 1, index 143
    virtual unknown_ret BOverlayIgnoreChildProcesses() = 0; //argc: 1, index 144
    virtual unknown_ret SetOverlayState() = 0; //argc: 2, index 145
    virtual unknown_ret NotifyOverlaySettingsChanged() = 0; //argc: 0, index 146
    virtual bool BIsBehindNAT() = 0; //argc: 0, index 147
    virtual unknown_ret GetMicroTxnAppID() = 0; //argc: 2, index 148
    virtual unknown_ret GetMicroTxnOrderID() = 0; //argc: 2, index 149
    virtual unknown_ret BGetMicroTxnPrice() = 0; //argc: 6, index 150
    virtual unknown_ret GetMicroTxnSteamRealm() = 0; //argc: 2, index 151
    virtual unknown_ret GetMicroTxnLineItemCount() = 0; //argc: 2, index 152
    virtual unknown_ret BGetMicroTxnLineItem() = 0; //argc: 11, index 153
    virtual unknown_ret BIsSandboxMicroTxn() = 0; //argc: 3, index 154
    virtual unknown_ret BMicroTxnRequiresCachedPmtMethod() = 0; //argc: 3, index 155
    virtual unknown_ret AuthorizeMicroTxn() = 0; //argc: 3, index 156
    virtual unknown_ret BGetWalletBalance() = 0; //argc: 3, index 157
    virtual unknown_ret RequestMicroTxnInfo() = 0; //argc: 2, index 158
    virtual unknown_ret BMicroTxnRefundable() = 0; //argc: 2, index 159
    virtual unknown_ret BGetAppMinutesPlayed() = 0; //argc: 3, index 160
    virtual unknown_ret GetAppLastPlayedTime() = 0; //argc: 1, index 161
    virtual unknown_ret GetAppUpdateDisabledSecondsRemaining() = 0; //argc: 1, index 162
    virtual unknown_ret BGetGuideURL() = 0; //argc: 3, index 163
    virtual unknown_ret BPromptToChangePassword() = 0; //argc: 0, index 164
    virtual unknown_ret BAccountExtraSecurity() = 0; //argc: 0, index 165
    virtual unknown_ret BAccountShouldShowLockUI() = 0; //argc: 0, index 166
    virtual unknown_ret GetCountAuthedComputers() = 0; //argc: 0, index 167
    virtual unknown_ret GetSteamGuardEnabledTime() = 0; //argc: 0, index 168
    virtual unknown_ret SetPhoneIsVerified() = 0; //argc: 1, index 169
    virtual bool BIsPhoneVerified() = 0; //argc: 0, index 170
    virtual unknown_ret SetPhoneIsIdentifying() = 0; //argc: 1, index 171
    virtual bool BIsPhoneIdentifying() = 0; //argc: 0, index 172
    virtual unknown_ret SetPhoneIsRequiringVerification() = 0; //argc: 1, index 173
    virtual bool BIsPhoneRequiringVerification() = 0; //argc: 0, index 174
    virtual unknown_ret Set2ndFactorAuthCode() = 0; //argc: 2, index 175
    virtual unknown_ret SetUserMachineName() = 0; //argc: 1, index 176
    virtual unknown_ret GetUserMachineName() = 0; //argc: 2, index 177
    virtual unknown_ret GetEmailDomainFromLogonFailure() = 0; //argc: 2, index 178
    virtual unknown_ret GetAgreementSessionUrl() = 0; //argc: 0, index 179
    ...
    virtual unknown_ret BGetDurationControlExtendedResults() = 0; //argc: 3, index 184
    virtual bool BIsSubscribedApp(AppId_t appid) = 0; //argc: 1, index 185
    virtual unknown_ret GetSubscribedApps() = 0; //argc: 3, index 186
    virtual unknown_ret AckSystemIM() = 0; //argc: 2, index 187
    virtual unknown_ret RequestSpecialSurvey() = 0; //argc: 1, index 188
    virtual unknown_ret SendSpecialSurveyResponse() = 0; //argc: 3, index 189
    virtual unknown_ret RequestNotifications() = 0; //argc: 0, index 190
    virtual bool GetAppOwnershipInfo(AppId_t appid, RTime32 *timeCreated, uint32_t *unk, char *countryCode) = 0; //argc: 4, index 191
    virtual unknown_ret SendGameWebCallback() = 0; //argc: 2, index 192
    virtual unknown_ret BIsStreamingUIToRemoteDevice() = 0; //argc: 0, index 193
    virtual unknown_ret BIsCurrentlyNVStreaming() = 0; //argc: 0, index 194
    virtual unknown_ret OnBigPictureForStreamingStartResult() = 0; //argc: 2, index 195
    virtual unknown_ret OnBigPictureForStreamingDone() = 0; //argc: 0, index 196
    virtual unknown_ret OnBigPictureForStreamingRestarting() = 0; //argc: 0, index 197
    virtual unknown_ret StopStreaming() = 0; //argc: 1, index 198
    virtual unknown_ret GetAllAccountFlags() = 0; //argc: 0, index 199
    virtual unknown_ret LockParentalLock() = 0; //argc: 0, index 200
    virtual unknown_ret UnlockParentalLock() = 0; //argc: 1, index 201
    virtual unknown_ret BIsParentalLockEnabled() = 0; //argc: 0, index 202
    virtual unknown_ret BIsParentalLockLocked() = 0; //argc: 0, index 203
    virtual unknown_ret BIsAppBlocked() = 0; //argc: 1, index 204
    virtual unknown_ret BIsAppInBlockList() = 0; //argc: 1, index 205
    virtual unknown_ret BIsFeatureBlocked() = 0; //argc: 1, index 206
    virtual unknown_ret BIsFeatureInBlockList() = 0; //argc: 1, index 207
    virtual unknown_ret GetParentalUnlockTime() = 0; //argc: 0, index 208
    virtual unknown_ret BGetRecoveryEmail() = 0; //argc: 2, index 209
    virtual unknown_ret BIsLockFromSiteLicense() = 0; //argc: 0, index 210
    virtual unknown_ret EIsParentalPlaytimeBlocked() = 0; //argc: 0, index 211
    virtual unknown_ret BGetSerializedParentalSettings() = 0; //argc: 1, index 212
    virtual unknown_ret BGetParentalWebToken() = 0; //argc: 2, index 213
    virtual unknown_ret GetCommunityPreference() = 0; //argc: 1, index 214
    virtual unknown_ret SetCommunityPreference() = 0; //argc: 2, index 215
    virtual unknown_ret GetTextFilterSetting() = 0; //argc: 0, index 216
    virtual unknown_ret BTextFilterIgnoresFriends() = 0; //argc: 0, index 217
    virtual unknown_ret CanLogonOffline() = 0; //argc: 0, index 218
    virtual unknown_ret LogOnOffline() = 0; //argc: 1, index 219
    virtual unknown_ret ValidateOfflineLogonTicket() = 0; //argc: 1, index 220
    virtual unknown_ret BGetOfflineLogonTicket() = 0; //argc: 2, index 221
    virtual unknown_ret UploadLocalClientLogs() = 0; //argc: 0, index 222
    virtual unknown_ret SetAsyncNotificationEnabled() = 0; //argc: 2, index 223
    virtual unknown_ret BIsOtherSessionPlaying() = 0; //argc: 1, index 224
    virtual unknown_ret BKickOtherPlayingSession() = 0; //argc: 0, index 225
    virtual unknown_ret BIsAccountLockedDown() = 0; //argc: 0, index 226
    virtual unknown_ret RequestAccountLinkInfo() = 0; //argc: 0, index 227
    virtual unknown_ret RequestSurveySchedule() = 0; //argc: 0, index 228
    virtual unknown_ret RequestNewSteamAnnouncementState() = 0; //argc: 0, index 229
    virtual unknown_ret UpdateSteamAnnouncementLastRead() = 0; //argc: 3, index 230
    virtual SteamAPICall_t GetMarketEligibility() = 0; //argc: 0, index 231
    virtual unknown_ret UpdateGameVrDllState() = 0; //argc: 3, index 232
    virtual unknown_ret KillVRTheaterPancakeGame() = 0; //argc: 1, index 233
    virtual unknown_ret SetVRIsHMDAwake() = 0; //argc: 1, index 234
    virtual unknown_ret BIsAnyGameOrServiceAppRunning() = 0; //argc: 0, index 235
    virtual unknown_ret BGetAppPlaytimeMap() = 0; //argc: 1, index 236
    virtual unknown_ret BGetAppsLastPlayedMap() = 0; //argc: 1, index 237
    virtual unknown_ret SendSteamServiceStatusUpdate() = 0; //argc: 2, index 238
    virtual unknown_ret RequestSteamGroupChatMessageNotifications() = 0; //argc: 5, index 239
    virtual unknown_ret RequestSteamGroupChatMessageHistory() = 0; //argc: 5, index 240
    virtual unknown_ret RequestSendSteamGroupChatMessage() = 0; //argc: 6, index 241
    virtual unknown_ret OnNewGroupChatMsgAdded() = 0; //argc: 8, index 242
    virtual unknown_ret OnGroupChatUserStateChange() = 0; //argc: 4, index 243
    virtual unknown_ret OnReceivedGroupChatSubscriptionResponse() = 0; //argc: 5, index 244
    ...
    virtual unknown_ret PrepareForSystemSuspend() = 0; //argc: 0, index 247
    virtual unknown_ret ResumeSuspendedGames() = 0; //argc: 1, index 248
    virtual unknown_ret GetClientInstallationID() = 0; //argc: 0, index 249
    virtual unknown_ret GetAppIDForGameID() = 0; //argc: 1, index 250
    virtual unknown_ret BDoNotDisturb() = 0; //argc: 0, index 251
    virtual unknown_ret SetAdditionalClientArgData() = 0; //argc: 1, index 252
    virtual unknown_ret GetFamilyGroupID() = 0; //argc: 0, index 253
    virtual unknown_ret GetFamilyGroupName() = 0; //argc: 0, index 254
    virtual unknown_ret GetFamilyGroupRole() = 0; //argc: 0, index 255
    virtual unknown_ret GetFamilyGroupMembers() = 0; //argc: 2, index 256
    virtual unknown_ret GetSharedAppLockInfo() = 0; //argc: 5, index 257
    virtual unknown_ret GetFamilyDLCForApp() = 0; //argc: 2, index 258
    virtual unknown_ret SetPreferredLender() = 0; //argc: 2, index 259
    virtual unknown_ret GetFamilyCopyCounts() = 0; //argc: 1, index 260
    virtual unknown_ret NotifyPendingGameLaunch_FetchSteamStreamingEncoderConfig() = 0; //argc: 1, index 261
    virtual unknown_ret BShouldWaitForSteamStreamingEncoderConfig() = 0; //argc: 1, index 262
    virtual unknown_ret BGetProcessIDsForGame() = 0; //argc: 3, index 263
    virtual unknown_ret CancelLicenseForApp() = 0; //argc: 1, index 264
};