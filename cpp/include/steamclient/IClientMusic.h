...
public:
    ...
    virtual unknown GetQueueCount() = 0; //argc: 0, index 4
    virtual unknown GetCurrentQueueEntry() = 0; //argc: 0, index 5
    virtual AudioPlayback_Status GetPlaybackStatus() = 0; //argc: 0, index 6
    virtual unknown SetPlayingRepeatStatus() = 0; //argc: 1, index 7
    virtual unknown GetPlayingRepeatStatus() = 0; //argc: 0, index 8
    virtual unknown TogglePlayingRepeatStatus() = 0; //argc: 0, index 9
    virtual unknown SetPlayingShuffled() = 0; //argc: 1, index 10
    virtual unknown IsPlayingShuffled() = 0; //argc: 0, index 11
    ...
    virtual unknown TogglePlayPause() = 0; //argc: 0, index 17
    virtual void SetVolume(float flVolume) = 0; //argc: 1, index 18
    virtual float GetVolume() = 0; //argc: 0, index 19
    virtual unknown ToggleMuteVolume() = 0; //argc: 0, index 20
    virtual unknown IncreaseVolume() = 0; //argc: 0, index 21
    virtual unknown DecreaseVolume() = 0; //argc: 0, index 22
    virtual unknown SetPlaybackPosition() = 0; //argc: 1, index 23
    virtual unknown GetPlaybackPosition() = 0; //argc: 0, index 24
    virtual unknown GetPlaybackDuration() = 0; //argc: 0, index 25
    virtual unknown ActivateRemotePlayerWithID() = 0; //argc: 1, index 26
    virtual unknown GetActiveRemotePlayerID() = 0; //argc: 0, index 27
    virtual unknown GetRemotePlayerCount() = 0; //argc: 0, index 28
    virtual unknown GetRemotePlayerIDAndName() = 0; //argc: 4, index 29
    virtual unknown GetCurrentEntryTextForRemotePlayerWithID() = 0; //argc: 3, index 30
    virtual unknown RegisterSteamMusicRemote() = 0; //argc: 1, index 31
    virtual unknown DeregisterSteamMusicRemote() = 0; //argc: 0, index 32
    virtual unknown BIsCurrentMusicRemote() = 0; //argc: 0, index 33
    virtual unknown BActivationSuccess() = 0; //argc: 1, index 34
    virtual unknown SetDisplayName() = 0; //argc: 1, index 35
    virtual unknown SetPNGIcon_64x64() = 0; //argc: 2, index 36
    ...
    virtual unknown CurrentEntryWillChange() = 0; //argc: 0, index 47
    ...
    virtual unknown UpdateCurrentEntryCoverArt() = 0; //argc: 2, index 51
    virtual unknown CurrentEntryDidChange() = 0; //argc: 0, index 52
    virtual unknown QueueWillChange() = 0; //argc: 0, index 53
    virtual unknown ResetQueueEntries() = 0; //argc: 0, index 54
    virtual unknown SetQueueEntry() = 0; //argc: 3, index 55
    virtual unknown SetCurrentQueueEntry() = 0; //argc: 1, index 56
    virtual unknown QueueDidChange() = 0; //argc: 0, index 57
    virtual unknown PlaylistWillChange() = 0; //argc: 0, index 58
    virtual unknown ResetPlaylistEntries() = 0; //argc: 0, index 59
    virtual unknown SetPlaylistEntry() = 0; //argc: 3, index 60
    virtual unknown SetCurrentPlaylistEntry() = 0; //argc: 1, index 61
    virtual unknown PlaylistDidChange() = 0; //argc: 0, index 62
    virtual unknown ReplacePlaylistWithSoundtrackAlbum() = 0; //argc: 1, index 63
    virtual unknown GetQueueSoundtrackAppID() = 0; //argc: 0, index 64
};