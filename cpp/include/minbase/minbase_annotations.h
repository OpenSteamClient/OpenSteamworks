...
// These macros are use for annotating array reference parameters, //====== Copyright 1996-2012, Valve Corporation, All rights reserved. ======//
//
// Static compilation analysis annotations.
//
//==========================================================================//
...
#endif // #ifndef MINBASE_ANNOTATIONS_Htypically used in functions
// such as V_strcpy_safe. Because they are array references the capacity is already known.
#if _MSC_VER >= 1700
#define IN_Z_ARRAY _Pre_z_
#define OUT_Z_ARRAY _Post_z_
