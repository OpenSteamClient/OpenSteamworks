...
/// Describe the address of a gameserver in a known PoP that is part
/// of the Steam Datagram relay network.  This is an intentionally
...
/// know, as it could reveal information useful to an attacker.  For that
/// reason, in production use cases the address will be encrypted with a
...
/// Ticket used to authenticate a client to talk to a specific gameserver.
/// Tickets are used for the connection/authentication flow where you want
/// your central matchmaking service ("game coordinator") to more tightly
