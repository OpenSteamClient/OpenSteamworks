...
public unsafe interface IClientDeviceAuth
{
    ...
    // WARNING: Arguments are unknown!
    public unknown GetDeviceAuthorizations(UInt64[] authorizations, int authorizationsMax, bool unk);  // argc: 3, index: 4, ipc args: [bytes4, bytes1], ipc returns: [bytes4, bytes_length_from_reg]
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public int GetAuthorizedBorrowers(Span<AccountID_t> owners, int ownersMax);  // argc: 2, index: 6, ipc args: [bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    // WARNING: Arguments are unknown!
    public int GetLocalUsers(Span<AccountID_t> owners, int ownersMax);  // argc: 2, index: 7, ipc args: [bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    /// <summary>
    ...
    // WARNING: Arguments are unknown!
    public SteamAPICall_t UpdateAuthorizedBorrowers(ReadOnlySpan<AccountID_t> accountids, uint accountidsLen, bool authorized);  // argc: 3, index: 9, ipc args: [bytes4, bytes_length_from_reg, bytes1], ipc returns: [bytes8]
    public int GetSharedLibraryOwners(Span<AccountID_t> owners, int ownersMax);  // argc: 2, index: 10, ipc args: [bytes4], ipc returns: [bytes4, bytes_length_from_reg]
}