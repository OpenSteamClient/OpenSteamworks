...
public unsafe interface IClientTimeline
{
    ...
    public unknown_ret StartGamePhase();  // argc: 0, index: 13, ipc args: [], ipc returns: []
    public unknown_ret EndGamePhase();  // argc: 0, index: 14, ipc args: [], ipc returns: []
    public unknown_ret SetGamePhaseID();  // argc: 1, index: 15, ipc args: [string], ipc returns: []
    public unknown_ret DoesGamePhaseRecordingExist();  // argc: 1, index: 16, ipc args: [string], ipc returns: [bytes8]
    public unknown_ret AddGamePhaseTag();  // argc: 4, index: 17, ipc args: [string, string, string, bytes4], ipc returns: []
    public unknown_ret SetGamePhaseAttribute();  // argc: 3, index: 18, ipc args: [string, string, bytes4], ipc returns: []
    ...
    public unknown_ret TakeInstantClipForGame();  // argc: 1, index: 23, ipc args: [bytes8], ipc returns: []
    public unknown_ret GetNextEventID();  // argc: 0, index: 24, ipc args: [], ipc returns: [bytes8]
    public unknown_ret UpdateGamePhase();  // argc: -1, index: 25, ipc args: [], ipc returns: []
    public unknown_ret AnswerDoesEventRecordingExist();  // argc: 3, index: 26, ipc args: [bytes8, bytes1], ipc returns: []
}