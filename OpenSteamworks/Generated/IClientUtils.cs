...
public unsafe interface IClientUtils
{
    ...
    /// </summary>
    // WARNING: Arguments are unknown!
    public bool GetAPICallResult(SteamAPICall_t handle, Span<byte> callbackData, int callbackDataMax, int expectedCallbackID, out bool failed);  // argc: 6, index: 25, ipc args: [bytes8, bytes4, bytes4], ipc returns: [bytes1, bytes_length_from_mem, bytes1]
    // WARNING: Arguments are unknown!
    public void SetAPICallResultWithoutPostingCallback(SteamAPICall_t handle, Span<byte> responseData, int responseDataLen, int responseCallbackID);  // argc: 5, index: 26, ipc args: [bytes8, bytes4, bytes4, bytes_length_from_mem], ipc returns: []
    ...
    // WARNING: Arguments are unknown!
    public unknown ShowGamepadTextInput();  // argc: 5, index: 42, ipc args: [bytes4, bytes4, string, bytes4, string], ipc returns: [bytes1]
    public unknown GetEnteredGamepadTextLength();  // argc: 0, index: 43, ipc args: [], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown GetEnteredGamepadTextInput();  // argc: 2, index: 44, ipc args: [bytes4], ipc returns: [bytes1, bytes_length_from_mem]
    // WARNING: Arguments are unknown!
    public unknown GamepadTextInputClosed();  // argc: 3, index: 45, ipc args: [bytes4, bytes1, string], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown ShowControllerLayoutPreview();  // argc: 3, index: 46, ipc args: [bytes4, bytes8], ipc returns: []
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public unknown SetVideoAdapterInfo();  // argc: 7, index: 53, ipc args: [bytes4, bytes4, bytes4, bytes4, bytes4, bytes4, string], ipc returns: []
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public unknown GetFocusedGameWindow();  // argc: 3, index: 56, ipc args: [], ipc returns: [bytes8, bytes1, bytes4]
    // WARNING: Arguments are unknown!
    public unknown SetControllerConfigFileForAppID(AppId_t appid, string config);  // argc: 2, index: 57, ipc args: [bytes4, string], ipc returns: [bytes1]
    // WARNING: Arguments are unknown!
    public unknown GetControllerConfigFileForAppID(AppId_t appid, StringBuilder config, int configMax);  // argc: 3, index: 58, ipc args: [bytes4, bytes4], ipc returns: [bytes1, bytes_length_from_mem]
    ...
    public bool GetSupportSystemReport(StringBuilder str, int strMax, Span<byte> bytes, int bytesMax);  // argc: 4, index: 64, ipc args: [bytes4, bytes4], ipc returns: [bytes1, bytes_length_from_mem, bytes_length_from_mem]
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public bool GetOverlayBrowserInfo(AppId_t appid, Span<byte> buf, uint bufMax);  // argc: 3, index: 71, ipc args: [bytes4], ipc returns: [bytes1, bytes_length_from_reg, bytes4]
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public unknown DispatchClientPostMessage(string unk, string unk1, string unk2);  // argc: 3, index: 81, ipc args: [string, string, string], ipc returns: [bytes4]
    ...
    // WARNING: Arguments are unknown!
    public unknown GetIPv6ConnectivityState(ESteamIPv6ConnectivityProtocol protocol);  // argc: 1, index: 86, ipc args: [bytes4], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown ScheduleConnectivityTest();  // argc: 2, index: 87, ipc args: [bytes4, bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown GetConnectivityTestState();  // argc: 1, index: 88, ipc args: [], ipc returns: [bytes4, bytes16]
    ...
    // WARNING: Arguments are unknown!
    public unknown GetSteamEnvironmentForApp(AppId_t appid, StringBuilder buf, int bufMax);  // argc: 3, index: 94, ipc args: [bytes4, bytes4], ipc returns: [bytes4, bytes_length_from_mem]
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public unknown ShowFloatingGamepadTextInput();  // argc: 6, index: 97, ipc args: [bytes4, bytes4, bytes4, bytes4, bytes4, bytes4], ipc returns: [bytes1]
    // WARNING: Arguments are unknown!
