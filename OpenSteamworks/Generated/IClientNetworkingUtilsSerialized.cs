...
public unsafe interface IClientNetworkingUtilsSerialized
{
    ...
    public unknown GetNetworkConfigJSON_DEPRECATED();  // argc: 3, index: 1, ipc args: [bytes4, string], ipc returns: [bytes4, bytes_length_from_mem]
    public unknown GetLauncherType();  // argc: 0, index: 2, ipc args: [], ipc returns: [bytes4]
