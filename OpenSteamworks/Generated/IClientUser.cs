...
public unsafe interface IClientUser
{
    ...
    // WARNING: Arguments are unknown!
    public unknown_ret SetClientStat();  // argc: 6, index: 140, ipc args: [bytes4, bytes8, bytes4, bytes4, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public SteamAPICall_t VerifyPassword(string password);  // argc: 1, index: 141, ipc args: [string], ipc returns: []
    public bool BSupportUser();  // argc: 0, index: 142, ipc args: [], ipc returns: [boolean]
    public bool BNeedsSSANextSteamLogon();  // argc: 0, index: 143, ipc args: [], ipc returns: [boolean]
    public void ClearNeedsSSANextSteamLogon();  // argc: 0, index: 144, ipc args: [], ipc returns: []
    public bool BIsAppOverlayEnabled(CGameID gameid);  // argc: 1, index: 145, ipc args: [bytes8], ipc returns: [boolean]
    public bool BOverlayIgnoreChildProcesses(CGameID gameid);  // argc: 1, index: 146, ipc args: [bytes8], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public void SetOverlayState(CGameID appid, uint unk);  // argc: 2, index: 147, ipc args: [bytes8, bytes4], ipc returns: []
    public void NotifyOverlaySettingsChanged();  // argc: 0, index: 148, ipc args: [], ipc returns: []
    public bool BIsBehindNAT();  // argc: 0, index: 149, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public unknown_ret GetMicroTxnAppID(GID_t transactionId);  // argc: 2, index: 150, ipc args: [bytes8], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret GetMicroTxnOrderID(GID_t transactionId);  // argc: 2, index: 151, ipc args: [bytes8], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret BGetMicroTxnPrice(GID_t transactionId, ref CAmount unk, ref CAmount unk2, ref bool unk3, int unk4);  // argc: 6, index: 152, ipc args: [bytes8], ipc returns: [boolean, bytes12, bytes12, boolean, bytes12]
    // WARNING: Arguments are unknown!
    public ESteamRealm GetMicroTxnSteamRealm(GID_t transactionId);  // argc: 2, index: 153, ipc args: [bytes8], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret GetMicroTxnLineItemCount(GID_t transactionId);  // argc: 2, index: 154, ipc args: [bytes8], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret BGetMicroTxnLineItem(GID_t transactionId, uint unk, ref int unk2, ref uint unk3, StringBuilder name, int nameMax, ref int unk4, byte* unk5, ref int unk6, ref bool unk7);  // argc: 11, index: 155, ipc args: [bytes8, bytes4, bytes4], ipc returns: [boolean, bytes12, bytes4, bytes_length_from_mem, bytes4, boolean, bytes12, boolean]
    // WARNING: Arguments are unknown!
    public bool BIsSandboxMicroTxn(GID_t transactionId, ref bool unk);  // argc: 3, index: 156, ipc args: [bytes8], ipc returns: [boolean, boolean]
    // WARNING: Arguments are unknown!
    public bool BMicroTxnRequiresCachedPmtMethod(GID_t transactionId, ref bool unk);  // argc: 3, index: 157, ipc args: [bytes8], ipc returns: [boolean, boolean]
    // WARNING: Arguments are unknown!
    public unknown_ret AuthorizeMicroTxn(GID_t transactionId, int unk);  // argc: 3, index: 158, ipc args: [bytes8, bytes4], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public bool BGetWalletBalance(out bool hasWallet, out CAmount amount, out CAmount amountPending);  // argc: 3, index: 159, ipc args: [], ipc returns: [boolean, boolean, bytes12, bytes12]
    // WARNING: Arguments are unknown!
    public unknown_ret RequestMicroTxnInfo(GID_t transactionId);  // argc: 2, index: 160, ipc args: [bytes8], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret BMicroTxnRefundable(GID_t transactionId);  // argc: 2, index: 161, ipc args: [bytes8], ipc returns: [boolean]
    public bool BGetAppMinutesPlayed(AppId_t appid, ref UInt32 allTime, ref UInt32 lastTwoWeeks);  // argc: 3, index: 162, ipc args: [bytes4], ipc returns: [boolean, bytes4, bytes4]
    public RTime32 GetAppLastPlayedTime(AppId_t appid);  // argc: 1, index: 163, ipc args: [bytes4], ipc returns: [bytes4]
    public uint GetAppUpdateDisabledSecondsRemaining(AppId_t appid);  // argc: 1, index: 164, ipc args: [bytes4], ipc returns: [bytes4]
    public bool BGetGuideURL(AppId_t appid, StringBuilder url, int urlMax);  // argc: 3, index: 165, ipc args: [bytes4, bytes4], ipc returns: [boolean, bytes_length_from_mem]
    public bool BPromptToChangePassword();  // argc: 0, index: 166, ipc args: [], ipc returns: [boolean]
    public bool BAccountExtraSecurity();  // argc: 0, index: 167, ipc args: [], ipc returns: [boolean]
    public bool BAccountShouldShowLockUI();  // argc: 0, index: 168, ipc args: [], ipc returns: [boolean]
    public int GetCountAuthedComputers();  // argc: 0, index: 169, ipc args: [], ipc returns: [bytes4]
    public RTime32 GetSteamGuardEnabledTime();  // argc: 0, index: 170, ipc args: [], ipc returns: [bytes4]
    public void SetPhoneIsVerified(bool val);  // argc: 1, index: 171, ipc args: [bytes1], ipc returns: []
    public bool BIsPhoneVerified();  // argc: 0, index: 172, ipc args: [], ipc returns: [boolean]
    public void SetPhoneIsIdentifying(bool val);  // argc: 1, index: 173, ipc args: [bytes1], ipc returns: []
    public bool BIsPhoneIdentifying();  // argc: 0, index: 174, ipc args: [], ipc returns: [boolean]
    public void SetPhoneIsRequiringVerification(bool val);  // argc: 1, index: 175, ipc args: [bytes1], ipc returns: []
    public bool BIsPhoneRequiringVerification();  // argc: 0, index: 176, ipc args: [], ipc returns: [boolean]
    public void Set2ndFactorAuthCode(string code, bool remember);  // argc: 2, index: 177, ipc args: [string, bytes1], ipc returns: []
    public void SetUserMachineName(string name);  // argc: 1, index: 178, ipc args: [string], ipc returns: []
    public void GetUserMachineName(StringBuilder name, int len);  // argc: 2, index: 179, ipc args: [bytes4], ipc returns: [bytes1, bytes_length_from_mem]
    // WARNING: Arguments are unknown!
    public bool GetEmailDomainFromLogonFailure(StringBuilder domain, int domainMax);  // argc: 2, index: 180, ipc args: [bytes4], ipc returns: [bytes1, bytes_length_from_mem]
    public string GetAgreementSessionUrl();  // argc: 0, index: 181, ipc args: [], ipc returns: [string]
    public SteamAPICall_t GetDurationControl();  // argc: 0, index: 182, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public UInt64 GetDurationControlForApp(AppId_t appid);  // argc: 1, index: 183, ipc args: [bytes4], ipc returns: [bytes8]
    public bool BSetDurationControlOnlineState(EDurationControlOnlineState eNewState);  // argc: 1, index: 184, ipc args: [bytes4], ipc returns: [boolean]
    public bool BSetDurationControlOnlineStateForApp(AppId_t appid, EDurationControlOnlineState eNewState);  // argc: 2, index: 185, ipc args: [bytes4, bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public bool BGetDurationControlExtendedResults();  // argc: 3, index: 186, ipc args: [bytes4], ipc returns: [boolean, boolean, boolean]
    /// <summary>
    ...
    public bool BIsSubscribedApp(AppId_t appid);  // argc: 1, index: 187, ipc args: [bytes4], ipc returns: [boolean]
    /// <summary>
    ...
    public uint GetSubscribedApps(uint[] arr, uint lengthOfArr, bool unk);  // argc: 3, index: 188, ipc args: [bytes4, bytes1], ipc returns: [bytes4, bytes_length_from_reg]
    // WARNING: Arguments are unknown!
    public unknown_ret AckSystemIM(GID_t id);  // argc: 2, index: 189, ipc args: [bytes8], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret RequestSpecialSurvey(uint surveyId);  // argc: 1, index: 190, ipc args: [bytes4], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret SendSpecialSurveyResponse(uint surveyId, byte[] data, int dataLength);  // argc: 3, index: 191, ipc args: [bytes4, bytes4, bytes_length_from_mem], ipc returns: [bytes8]
    public unknown_ret RequestNotifications();  // argc: 0, index: 192, ipc args: [], ipc returns: []
    // WARNING: Arguments are unknown!
    /// <summary>
    /// 
    /// </summary>
    ...
    /// <returns></returns>
    public unknown_ret GetAppOwnershipInfo(AppId_t appid, out RTime32 timeCreated, out UInt32 unk, StringBuilder country);  // argc: 4, index: 193, ipc args: [bytes4], ipc returns: [bytes1, bytes4, bytes4, bytes3]
    // WARNING: Arguments are unknown!
    public unknown_ret SendGameWebCallback(AppId_t appid, string data);  // argc: 2, index: 194, ipc args: [bytes4, string], ipc returns: []
    public bool BIsStreamingUIToRemoteDevice();  // argc: 0, index: 195, ipc args: [], ipc returns: [boolean]
    public bool BIsCurrentlyNVStreaming();  // argc: 0, index: 196, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    [BlacklistedInCrossProcessIPC]
    public unknown_ret OnBigPictureForStreamingStartResult();  // argc: 2, index: 197, ipc args: [bytes1, bytes4], ipc returns: []
    public unknown_ret OnBigPictureForStreamingDone();  // argc: 0, index: 198, ipc args: [], ipc returns: []
    public unknown_ret OnBigPictureForStreamingRestarting();  // argc: 0, index: 199, ipc args: [], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret StopStreaming(AppId_t appid);  // argc: 1, index: 200, ipc args: [bytes4], ipc returns: []
    public unknown_ret GetAllAccountFlags();  // argc: 0, index: 201, ipc args: [], ipc returns: [bytes4]
    public unknown_ret LockParentalLock();  // argc: 0, index: 202, ipc args: [], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret UnlockParentalLock(string unk);  // argc: 1, index: 203, ipc args: [string], ipc returns: [bytes1]
    public bool BIsParentalLockEnabled();  // argc: 0, index: 204, ipc args: [], ipc returns: [boolean]
    public bool BIsParentalLockLocked();  // argc: 0, index: 205, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    ...
    public bool BIsLockFromSiteLicense();  // argc: 0, index: 212, ipc args: [], ipc returns: [boolean]
    public unknown_ret EIsParentalPlaytimeBlocked();  // argc: 0, index: 213, ipc args: [], ipc returns: [bytes4]
    public bool BGetSerializedParentalSettings(CUtlBuffer* serialized);  // argc: 1, index: 214, ipc args: [], ipc returns: [boolean, unknown]
    public bool BGetParentalWebToken(CUtlBuffer* unk1, CUtlBuffer* unk2);  // argc: 2, index: 215, ipc args: [], ipc returns: [boolean, unknown, unknown]
    /// <summary>
    /// Only preference 0 seems to exist.
    /// </summary>
    public uint GetCommunityPreference(int preference);  // argc: 1, index: 216, ipc args: [bytes4], ipc returns: [bytes1]
    /// <summary>
    /// Only preference 0 seems to exist.
    /// </summary>
    public void SetCommunityPreference(int preference, uint value);  // argc: 2, index: 217, ipc args: [bytes4, bytes1], ipc returns: []
    public uint GetTextFilterSetting();  // argc: 0, index: 218, ipc args: [], ipc returns: [bytes4]
    public bool BTextFilterIgnoresFriends();  // argc: 0, index: 219, ipc args: [], ipc returns: [boolean]
    /// <summary>
    /// Can return 0, 1 or 2 or a mystery uint. Probably is an enum of some sort.
    /// </summary>
    public unknown_ret CanLogonOffline();  // argc: 0, index: 220, ipc args: [], ipc returns: [bytes4]
    /// <summary>
    /// Returns 19, same mystery uint as CanLogonOffline or 1
    /// Also unk1 only seems to affect the callback that gets posted.
    /// </summary>
    public unknown_ret LogOnOffline(byte unk1);  // argc: 1, index: 221, ipc args: [bytes1], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret ValidateOfflineLogonTicket();  // argc: 1, index: 222, ipc args: [string], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public bool BGetOfflineLogonTicket(StringBuilder ticket, int ticketMax);  // argc: 2, index: 223, ipc args: [string], ipc returns: [boolean, unknown]
    public SteamAPICall_t UploadLocalClientLogs();  // argc: 0, index: 224, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public void SetAsyncNotificationEnabled(AppId_t appid, bool val);  // argc: 2, index: 225, ipc args: [bytes4, bytes1], ipc returns: []
    public bool BIsOtherSessionPlaying(ref UInt32 accountID);  // argc: 1, index: 226, ipc args: [], ipc returns: [boolean, bytes4]
    public bool BKickOtherPlayingSession();  // argc: 0, index: 227, ipc args: [], ipc returns: [boolean]
    public bool BIsAccountLockedDown();  // argc: 0, index: 228, ipc args: [], ipc returns: [boolean]
    public SteamAPICall_t RequestAccountLinkInfo();  // argc: 0, index: 229, ipc args: [], ipc returns: [bytes8]
    public unknown_ret RequestSurveySchedule();  // argc: 0, index: 230, ipc args: [], ipc returns: []
    public unknown_ret RequestNewSteamAnnouncementState();  // argc: 0, index: 231, ipc args: [], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret UpdateSteamAnnouncementLastRead();  // argc: 3, index: 232, ipc args: [bytes8, bytes4], ipc returns: []
    public unknown_ret GetMarketEligibility();  // argc: 0, index: 233, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret UpdateGameVrDllState(CGameID gameid, bool unk, bool unk2);  // argc: 3, index: 234, ipc args: [bytes8, bytes1, bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret KillVRTheaterPancakeGame(CGameID gameid);  // argc: 1, index: 235, ipc args: [bytes8], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret SetVRIsHMDAwake();  // argc: 1, index: 236, ipc args: [bytes1], ipc returns: []
    public bool BIsAnyGameOrServiceAppRunning();  // argc: 0, index: 237, ipc args: [], ipc returns: [boolean]
    [BlacklistedInCrossProcessIPC]
    public bool BGetAppPlaytimeMap(CUtlMap<AppId_t, AppPlaytime_t>* vec);  // argc: 1, index: 238, ipc args: [bytes4], ipc returns: [boolean]
    [BlacklistedInCrossProcessIPC]
    public bool BGetAppsLastPlayedMap(CUtlMap<AppId_t, RTime32>* vec);  // argc: 1, index: 239, ipc args: [bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public unknown_ret SendSteamServiceStatusUpdate(EResult unk1, ESteamServiceStatusUpdate unk2);  // argc: 2, index: 240, ipc args: [bytes4, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public EResult RequestSteamGroupChatMessageNotifications();  // argc: 5, index: 241, ipc args: [bytes8, bytes8, bytes4], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret RequestSteamGroupChatMessageHistory();  // argc: 5, index: 242, ipc args: [bytes8, bytes8, bytes4], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret RequestSendSteamGroupChatMessage();  // argc: 6, index: 243, ipc args: [bytes8, bytes8, bytes4, string], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public unknown_ret OnNewGroupChatMsgAdded();  // argc: 8, index: 244, ipc args: [bytes8, bytes8, bytes4, bytes4, bytes4, string], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret OnGroupChatUserStateChange();  // argc: 4, index: 245, ipc args: [bytes8, bytes4, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret OnReceivedGroupChatSubscriptionResponse();  // argc: 5, index: 246, ipc args: [bytes8, bytes8, bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
    public unknown_ret GetTimedTrialStatus();  // argc: 4, index: 247, ipc args: [bytes4], ipc returns: [bytes1, bytes1, bytes4, bytes4]
    public SteamAPICall_t RequestTimedTrialStatus(AppId_t appid);  // argc: 1, index: 248, ipc args: [bytes4], ipc returns: [bytes1]
    public unknown_ret PrepareForSystemSuspend();  // argc: 0, index: 249, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public unknown_ret ResumeSuspendedGames();  // argc: 1, index: 250, ipc args: [bytes1], ipc returns: [bytes8]
    public UInt64 GetClientInstallationID();  // argc: 0, index: 251, ipc args: [], ipc returns: [bytes8]
    // WARNING: Arguments are unknown!
    public AppId_t GetAppIDForGameID(in CGameID gameid);  // argc: 1, index: 252, ipc args: [bytes8], ipc returns: [bytes4]
    public bool BDoNotDisturb();  // argc: 0, index: 253, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    public void SetAdditionalClientArgData(string data);  // argc: 1, index: 254, ipc args: [bytes5], ipc returns: []
    public ulong GetFamilyGroupID();  // argc: 0, index: 255, ipc args: [], ipc returns: [bytes8]
    public string GetFamilyGroupName();  // argc: 0, index: 256, ipc args: [], ipc returns: [string]
    public uint GetFamilyGroupRole();  // argc: 0, index: 257, ipc args: [], ipc returns: [bytes4]
    public int GetFamilyGroupMembers(uint[] memberAccountIDs, int maxLen);  // argc: 2, index: 258, ipc args: [bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    // WARNING: Arguments are unknown!
    public bool GetSharedAppLockInfo(AppId_t appid, out bool isLocked, out uint unk, out uint unk2, out uint unk3, out bool unk4);  // argc: 5, index: 259, ipc args: [bytes4], ipc returns: [bytes1, bytes4, bytes4, bytes4, bytes1]
    // WARNING: Arguments are unknown!
    [BlacklistedInCrossProcessIPC]
    public bool GetFamilyDLCForApp(AppId_t appid, CUtlVector<uint>* dlcIDs);  // argc: 2, index: 260, ipc args: [bytes4, bytes4], ipc returns: [bytes1]
    // WARNING: Arguments are unknown!
    public SteamAPICall_t SetPreferredLender(AppId_t appid, uint accountID);  // argc: 2, index: 261, ipc args: [bytes4, bytes4], ipc returns: [bytes8]
    [BlacklistedInCrossProcessIPC]
    public bool GetFamilyCopyCounts(CUtlMap<AppId_t, int>* counts);  // argc: 1, index: 262, ipc args: [bytes4], ipc returns: [bytes1]
    // WARNING: Arguments are unknown!
    public void NotifyPendingGameLaunch_FetchSteamStreamingEncoderConfig(AppId_t appid);  // argc: 1, index: 263, ipc args: [bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public bool BShouldWaitForSteamStreamingEncoderConfig(AppId_t appid);  // argc: 1, index: 264, ipc args: [bytes4], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
    [BlacklistedInCrossProcessIPC]
    public bool BGetProcessIDsForGame(CGameID gameid, CUtlVector<uint>* gameIDs);  // argc: 3, index: 265, ipc args: [bytes8, bytes4, bytes4], ipc returns: [boolean]
    public SteamAPICall_t CancelLicenseForApp(AppId_t appid);  // argc: 1, index: 266, ipc args: [bytes4], ipc returns: [bytes8]
}