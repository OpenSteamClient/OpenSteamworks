...
public unsafe interface IClientCompat
{
    ...
    public void GetAvailableCompatToolsFiltered(CUtlStringList* compatTools, ERemoteStoragePlatform platform, int unk = 0);  // argc: 3, index: 3, ipc args: [bytes4, bytes4, bytes4], ipc returns: []
    [BlacklistedInCrossProcessIPC]
    ...
    public void SpecifyCompatTool(AppId_t appid, string toolName, string config, int priority);  // argc: 4, index: 5, ipc args: [bytes4, string, string, bytes4], ipc returns: []
    // WARNING: Arguments are unknown!
    public void SpecifyCompatExperiment(AppId_t appid, string experiment, int unk);  // argc: 3, index: 6, ipc args: [bytes4, string, bytes4], ipc returns: []
    ...
    [BlacklistedInCrossProcessIPC]
    public unknown_ret GetAppCompatCategories();  // argc: 2, index: 12, ipc args: [bytes4, bytes4], ipc returns: []
