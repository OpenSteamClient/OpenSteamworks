...
public unsafe interface IClientSystemPerfManager
{
    ...
    public unknown_ret GetDiagnosticInfo();  // argc: 1, index: 2, ipc args: [], ipc returns: [bytes1, unknown]
    // WARNING: Arguments are unknown!
    public unknown_ret GetState();  // argc: 1, index: 3, ipc args: [], ipc returns: [bytes1, unknown]
    // WARNING: Arguments are unknown!
