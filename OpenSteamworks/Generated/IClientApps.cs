...
public unsafe interface IClientApps
{
    ...
    /// </summary>
    /// <returns></returns>
    public unknown_ret GetMultipleAppDataSections(AppId_t unAppID, EAppInfoSection[] sections, int sectionsCount, byte[] pchBuffer, int cbBufferMax, bool bSharedKVSymbols, int[] sectionLengths);  // argc: 7, index: 7, ipc args: [bytes4, bytes4, bytes_length_from_reg, bytes4, bytes1], ipc returns: [bytes4, bytes_length_from_reg, bytes_length_from_mem]
