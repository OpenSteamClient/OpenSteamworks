...
public unsafe interface IClientAppManager
{
    ...
    // WARNING: Arguments are unknown!
    public int GetAvailableLanguages(AppId_t appid, bool unk, StringBuilder langOut, int maxLangOut);  // argc: 4, index: 23, ipc args: [bytes4, bytes1, bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    /// <summary>
    /// Gets the current language of the app.
    /// </summary>
    /// <returns>How much data was returned. Trimmed if buffer is too small.</returns>
    public int GetCurrentLanguage(AppId_t app, StringBuilder langOut, int maxLangOut);  // argc: 3, index: 24, ipc args: [bytes4, bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    ...
    public bool GetAutoUpdateTimeRestrictionEnabled();  // argc: 0, index: 44, ipc args: [], ipc returns: [bytes1]
    public void SetAutoUpdateTimeRestrictionEnabled(bool val);  // argc: 1, index: 45, ipc args: [bytes1], ipc returns: []
    public bool GetAutoUpdateTimeRestrictionHours(out int startTime, out int endTime);  // argc: 2, index: 46, ipc args: [], ipc returns: [bytes1, bytes4, bytes4]
    ...
    public bool SetAppAutoUpdateBehavior(AppId_t appid, EAppAutoUpdateBehavior val);  // argc: 2, index: 50, ipc args: [bytes4, bytes4], ipc returns: [bytes1]
    public bool SetAppAllowDownloadsWhileRunningBehavior(AppId_t appid, EAppAllowDownloadsWhileRunningBehavior val);  // argc: 2, index: 51, ipc args: [bytes4, bytes4], ipc returns: [bytes1]
    public EAppAllowDownloadsWhileRunningBehavior GetAppAllowDownloadsWhileRunningBehavior(AppId_t appid);  // argc: 1, index: 52, ipc args: [bytes4], ipc returns: [bytes4]
    public void SetAllowDownloadsWhileAnyAppRunning(bool val);  // argc: 1, index: 53, ipc args: [bytes1], ipc returns: []
    public bool BAllowDownloadsWhileAnyAppRunning();  // argc: 0, index: 54, ipc args: [], ipc returns: [boolean]
    public bool ChangeAppDownloadQueuePlacement(AppId_t appid, EAppDownloadQueuePlacement placement);  // argc: 2, index: 55, ipc args: [bytes4, bytes4], ipc returns: [bytes1]
    public bool SetAppDownloadQueueIndex(AppId_t appid, int index);  // argc: 2, index: 56, ipc args: [bytes4, bytes4], ipc returns: [bytes1]
    public int GetAppDownloadQueueIndex(AppId_t appid);  // argc: 1, index: 57, ipc args: [bytes4], ipc returns: [bytes4]
    public RTime32 GetAppAutoUpdateDelayedUntilTime(AppId_t appid);  // argc: 1, index: 58, ipc args: [bytes4], ipc returns: [bytes4]
    public int GetNumAppsInDownloadQueue();  // argc: 0, index: 59, ipc args: [], ipc returns: [bytes4]
    public bool BHasLocalContentServer();  // argc: 0, index: 60, ipc args: [], ipc returns: [boolean]
    /// <summary>
    ...
    public int GetLibraryFolderPath(LibraryFolder_t folder, StringBuilder outPath, int outPathMaxLength);  // argc: 3, index: 75, ipc args: [bytes4, bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    public LibraryFolder_t AddLibraryFolder(string folderPath);  // argc: 1, index: 76, ipc args: [string], ipc returns: [bytes4]
    public void SetLibraryFolderLabel(LibraryFolder_t folder, string label);  // argc: 2, index: 77, ipc args: [bytes4, string], ipc returns: []
    public int GetLibraryFolderLabel(LibraryFolder_t folder, StringBuilder outLabel, int outLabelMaxLength);  // argc: 3, index: 78, ipc args: [bytes4, bytes4], ipc returns: [bytes4, bytes_length_from_reg]
    // WARNING: Arguments are unknown!
    /// <summary>
    ...
    public uint RemoveLibraryFolder(LibraryFolder_t libraryFolder, bool unk1 = false, bool unk2 = false);  // argc: 3, index: 79, ipc args: [bytes4, bytes1, bytes1], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    [BlacklistedInCrossProcessIPC]
    public bool BGetLibraryFolderInfo(LibraryFolder_t libraryFolder, out bool mounted, out UInt64 usedDiskSpace, out UInt64 freeDiskSpace);  // argc: 4, index: 80, ipc args: [bytes4, bytes4, bytes4, bytes4], ipc returns: [boolean]
    ...
    /// </summary>
    public void ForceInstallDirOverride(string directory);  // argc: 1, index: 85, ipc args: [string], ipc returns: []
    // WARNING: Arguments are unknown!
    public bool SetDownloadThrottleRateKbps(int rate, bool unk);  // argc: 2, index: 86, ipc args: [bytes4, bytes1], ipc returns: [bytes1]
    // WARNING: Arguments are unknown!
    public int GetDownloadThrottleRateKbps(bool unk);  // argc: 1, index: 87, ipc args: [bytes1], ipc returns: [bytes4]
    // WARNING: Arguments are unknown!
    public void SuspendDownloadThrottling(bool val);  // argc: 1, index: 88, ipc args: [bytes1], ipc returns: []
    public void SetThrottleDownloadsWhileStreaming(bool val);  // argc: 1, index: 89, ipc args: [bytes1], ipc returns: []
    public bool BThrottleDownloadsWhileStreaming();  // argc: 0, index: 90, ipc args: [], ipc returns: [boolean]
    public string GetLaunchQueryParam(AppId_t appid, string key);  // argc: 2, index: 91, ipc args: [bytes4, string], ipc returns: [string]
    public void BeginLaunchQueryParams(AppId_t appid);  // argc: 1, index: 92, ipc args: [bytes4], ipc returns: []
    public void SetLaunchQueryParam(AppId_t appid, string key, string value);  // argc: 3, index: 93, ipc args: [bytes4, string, string], ipc returns: []
    public bool CommitLaunchQueryParams(AppId_t appid, string unk);  // argc: 2, index: 94, ipc args: [bytes4, string], ipc returns: [bytes1]
    public int GetLaunchCommandLine(AppId_t appid, StringBuilder commandLine, int commandLineMax);  // argc: 3, index: 95, ipc args: [bytes4, bytes4], ipc returns: [bytes4, bytes_length_from_mem]
    public void AddContentLogLine(string msg);  // argc: 1, index: 96, ipc args: [string], ipc returns: []
    public void SetUseHTTPSForDownloads(bool val);  // argc: 1, index: 97, ipc args: [bytes1], ipc returns: []
    public bool GetUseHTTPSForDownloads();  // argc: 0, index: 98, ipc args: [], ipc returns: [bytes1]
    public void SetPeerContentServerMode(EPeerContentMode mode);  // argc: 1, index: 99, ipc args: [bytes4], ipc returns: []
    public void SetPeerContentClientMode(EPeerContentMode mode);  // argc: 1, index: 100, ipc args: [bytes4], ipc returns: []
    public EPeerContentMode GetPeerContentServerMode();  // argc: 0, index: 101, ipc args: [], ipc returns: [bytes4]
    public EPeerContentMode GetPeerContentClientMode();  // argc: 0, index: 102, ipc args: [], ipc returns: [bytes4]
    public bool GetPeerContentServerStats(out PeerContentServerStats_s stats);  // argc: 1, index: 103, ipc args: [], ipc returns: [bytes1, bytes40]
    // WARNING: Arguments are unknown!
    public void SuspendPeerContentClient(bool unk);  // argc: 1, index: 104, ipc args: [bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
    public void SuspendPeerContentServer(bool unk);  // argc: 1, index: 105, ipc args: [bytes1], ipc returns: []
    // WARNING: Arguments are unknown!
    public string GetPeerContentServerForApp(AppId_t appid, out bool unk1, out bool unk2);  // argc: 3, index: 106, ipc args: [bytes4], ipc returns: [string, bytes1, bytes1]
    public void NotifyDriveAdded(string drivePath);  // argc: 1, index: 107, ipc args: [string], ipc returns: []
    public void NotifyDriveRemoved(string drivePath);  // argc: 1, index: 108, ipc args: [string], ipc returns: []
    public void SetAudioDownloadQuality(bool bHighQuality);  // argc: 1, index: 109, ipc args: [bytes1], ipc returns: []
}