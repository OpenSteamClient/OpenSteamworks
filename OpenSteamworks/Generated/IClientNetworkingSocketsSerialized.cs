...
public unsafe interface IClientNetworkingSocketsSerialized
{
    ...
    public void SendP2PRendezvous(UInt64 unk, uint unk1, ReadOnlySpan<byte> msg, uint msgLen);  // argc: 5, index: 1, ipc args: [uint64, bytes4, bytes4, bytes_length_from_mem], ipc returns: []
    // WARNING: Arguments are unknown!
    ...
    // WARNING: Arguments are unknown!
    public void CacheRelayTicket(Span<byte> msg, uint len);  // argc: 2, index: 4, ipc args: [bytes4, bytes_length_from_mem], ipc returns: []
    ...
    // WARNING: Arguments are unknown!
    public unknown AllowDirectConnectToPeerString(string peerString, out uint unk);  // argc: 1, index: 10, ipc args: [string], ipc returns: [unknown, bytes4]
    // WARNING: Arguments are unknown!
