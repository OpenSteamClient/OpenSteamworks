...
public unsafe interface IClientSharedConnection
{
    ...
    public bool SendMessage(HSharedConnection connection, byte[] msg, UInt32 size);  // argc: 3, index: 3, ipc args: [bytes4, bytes4, bytes_length_from_mem], ipc returns: [bytes1]
    public HSharedConnectionMsg SendMessageAndAwaitResponse(HSharedConnection connection, byte[] msg, UInt32 size);  // argc: 3, index: 4, ipc args: [bytes4, bytes4, bytes_length_from_mem], ipc returns: [bytes4]
