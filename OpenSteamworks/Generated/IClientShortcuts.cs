...
public unsafe interface IClientShortcuts
{
    ...
    public bool GetShortcutInfoByIndex(int index, out CMsgShortcutInfo shortcutInfo);  // argc: 2, index: 6, ipc args: [bytes4], ipc returns: [bytes1, unknown]
    public bool GetShortcutInfoByAppID(AppId_t appid, out CMsgShortcutInfo shortcutInfo);  // argc: 2, index: 7, ipc args: [bytes4], ipc returns: [bytes1, unknown]
    ...
    public AppId_t AddOpenVRShortcut(string name, string exepath, string icon);  // argc: 4, index: 10, ipc args: [string, string, string, bytes4], ipc returns: [bytes4]
    ...
    public void SetShortcutHidden(AppId_t appid, bool bHidden);  // argc: 2, index: 17, ipc args: [bytes4, bytes1], ipc returns: []
