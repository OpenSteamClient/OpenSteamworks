...
public unsafe interface IClientVR
{
    ...
    public unknown GetCurrentHmd();  // argc: 0, index: 1, ipc args: [], ipc returns: [bytes4]
    [BlacklistedInCrossProcessIPC]
    public unknown GetCompositor();  // argc: 0, index: 2, ipc args: [], ipc returns: [bytes4]
    [BlacklistedInCrossProcessIPC]
    public unknown GetOverlay();  // argc: 0, index: 3, ipc args: [], ipc returns: [bytes4]
    [BlacklistedInCrossProcessIPC]
    public unknown GetSettings();  // argc: 0, index: 4, ipc args: [], ipc returns: [bytes4]
    [BlacklistedInCrossProcessIPC]
    public unknown GetProperties();  // argc: 0, index: 5, ipc args: [], ipc returns: [bytes4]
    [BlacklistedInCrossProcessIPC]
    public unknown GetPaths();  // argc: 0, index: 6, ipc args: [], ipc returns: [bytes4]
    ...
    // WARNING: Arguments are unknown!
    public unknown BGetMutualCapabilities();  // argc: 1, index: 19, ipc args: [], ipc returns: [boolean, unknown]
    ...
    public unknown BServeVRGamepadUIViaGamescope();  // argc: 0, index: 22, ipc args: [], ipc returns: [boolean]
    // WARNING: Arguments are unknown!
