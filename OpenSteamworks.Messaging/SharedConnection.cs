...
// 	internal SharedConnection(ISteamClient steamClient, ILoggerFactory loggerFactory)
// 	{
...
// 		this.frameTaskDisposable = steamClient.CallbackManager.AddFrameTask(RunFrame);
// 	}
//
// 	private void RunFrame()
// 	{
// 		using CUtlBuffer buf = new();
// 		while (sharedConnection.BPopReceivedMessage(Handle, in buf, out uint hCall))
// 		{
// 			OnMsgReceived(buf.ToManaged(), hCall);
// 			buf.SeekToBeginning();
// 		}
// 	}
//
...
// 		if (!msg.IsProto)
// 		{
// 			logger.Warning("Got non-proto service method!");
// 			return;
// 		}
//
...
// 	} 
//
// 	public async Task<ProtoMsgBase> SendAndWaitForServiceResponse(ProtoMsgBase message)
// 	{
// 		await ConnectIfNotConnected();
// 		RewriteMessage(message);
// 		using var stream = new MemoryStream();
...
// 			// This means mismatches can occur :(
